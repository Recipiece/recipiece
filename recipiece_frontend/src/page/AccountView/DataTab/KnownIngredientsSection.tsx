...
export const KnownIngredientsSection: FC = () => {
  ...
  return (
    <Stack>
      ...
      <p className="text-sm">
        Recipiece maintains a list of volume to weight conversions for common ingredients. When converting ingredients,
        Recipiece will use the base unit of either grams or U.S. cups to traverse from volume to weight as vice versa.
        For ingredients that are often listed without units (eggs, for example), Recipiece will use the value in the{" "}
