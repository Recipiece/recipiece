...
export const FromUserTable: FC = () => {
  ...
  const { mutateAsync: createKitchenMembership, isPending: isCreatingKitchenMembership } =
    useCreateKitchenMembershipMutation();
  const { deleteUserKitchenMembership, isDeletingUserKitchenMembership } =
    useDeleteUserKitchenMembershipDialog("source_user");
    ...
    <div>
      <div className="mb-2 flex flex-row items-center">
        ...
        <Button
          variant="secondary"
          className="ml-auto"
          disabled={isCreatingKitchenMembership}
              ...
              return (
                ...
                >
                  ...
                  {membership.status === "accepted" && (
                    <Button
                      variant="ghost"
                      onClick={() => navigate(`/kitchen/${membership.id}`)}
                      disabled={isDeletingUserKitchenMembership}
                    >
